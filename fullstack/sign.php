...
if(isset($_POST['firname'])){
    ...
    if($count > 0){
        ...
        $sql = "INSERT INTO `details` (`first_name`, `last_name`, `email`, `password`) VALUES ('$firname', '$lastname', '$email', '$pass1')";
...
<form  onclick=" return checkpass()" action="sign.php" method="post">
    <div class="container">
        <br><br><h1><p align="center"><u>SIGN UP</u></p></h1>
        <label for="firname"><br><br>&nbsp;FIRST NAME : </label><br><br>
        <input type="text" id="firname" name="firname" placeholder="  enter your first name" onmouseover="this.placeholder = ' '" ; onmouseout="this.placeholder = '  enter your first name'" required><br><br><br>
        <label for="lastname">&nbsp;LAST NAME : </label><br><br>
        <input type="text" id="lastname" name="lastname" placeholder="  enter your last name" onmouseover="this.placeholder = ' '" ; onmouseout="this.placeholder = '  enter your last name'" required><br><br><br>
        <label for="emai">&nbsp;E-MAIL : </label><br><br>
        <input type="email" id="emai" name="email" placeholder="  enter your email" onmouseover="this.placeholder = ' '" ; onmouseout="this.placeholder = '  enter your email'" required><br>
        <small id="firstone">&nbsp;We will never share your email with anyone</small><br><br><br>
        <label for="pass1">&nbsp;PASSWORD : </label><br><br>
        <input type="password" id="pass1" name="pass1" placeholder="  enter your password" onmouseover="this.placeholder = ' '" ; onmouseout="this.placeholder = '  enter your password'" required><br><br><br>
        <label for="pass2"> &nbsp;CONFIRM PASSWORD : </label><br><br>
        <input type="password" id="pass2" name="pass2" placeholder="  confirm your password" onmouseover="this.placeholder = ' '" ; onmouseout="this.placeholder = '  confirm your password'" required><br>
        <p id="msg" style="color: red; font-size: large;"></p><p id="msgg" style="color: green; font-size: large;"></p>
        <br><br>
        <input type="submit" class="one" value="Submit" onclick="pass()" style="font-size:larger;font-family: Cambria, Cochin, Georgia, Times, 'Times New Roman', serif; cursor: pointer;">
    </div>
</form>
<br><h3><p align="center">Already have an account ? <a href="loginform.html">LOGIN</a></p></h3><br><br>
</body>
</html>